...
sidebarTitle: "Generate a Translation File"
...
However, you can **reduce the number of translation credits you consume** and **speed up load times** by generating this file up front.
...
*Note: Make sure your remove the `targetLanguage` prop once you're done generating translations or your app will just always be in Spanish!*
